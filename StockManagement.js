...
const StockManagement = () => {
    ...
    const handleUpdateStock = (e) => {
        ...
        alert('Stock was successfully updated');
    };
    ...
    return (
        <section>
            <h2>SELLING OR ADDING OF STOCK</h2>
            ...
            <button onClick={handleViewStock}>View available Stock</button>
        </section>
    );
};
